...
logic [SIG_WIDTH + 1:0] SIG_intermediate;
  ...
  always @(*) begin
    if((SIG_in[2] == 1'b1 && SIG_in[1] == 1'b1) || (SIG_in[3] == 1'b1 && SIG_in[2] == 1'b1 && SIG_in[1] == 1'b0)) begin
      ...
      SIG_intermediate = {1'b0, SIG_in[SIG_WIDTH + 3:3]};
    end

    if (SIG_intermediate[SIG_WIDTH + 1] == 1'b1) begin
        SIG_out = SIG_intermediate[SIG_WIDTH + 1:1];
        EXP_out = EXP_in + 1;
    end else begin
        SIG_out = SIG_intermediate[SIG_WIDTH:0];
        EXP_out = EXP_in;
    end
  end
