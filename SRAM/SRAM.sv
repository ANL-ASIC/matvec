...
module SRAM #(
    ...
    input  logic [number_of_columns_per_frame-1:0][K-1:0][weight_width-1:0] write_data, // packed
    output logic [[number_of_columns_per_frame-1:0][K-1:0][weight_width-1:0] data_out    // packed
);
